...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
 ...
 <body>
 	...
 	<div id="wrapperContent">
 		...
 		<p style="text-align:center; color:#3B6E9E; font-size:20px; font-weight: bold">I am very familiar with this area of Santa Barbara.</p>
 	...
 	<form name="twenty" id="twenty" method="post" action="13.php">
