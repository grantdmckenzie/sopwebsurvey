<?php
	...
	*/
	...
	if (isset($_POST['s1'])) {
		...
		// update the page
		$query = "UPDATE users SET page = '19', lastaccess = '".date("Y-m-d H:i:s")."' WHERE id = ". $wsuser->id;
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
 ...
 <body>
 	...
 	<div id="wrapperContent">
 		...
 		<p style="text-align:center; font-size 16px; font-weight: bold">This area is a dangerous area of Santa Barbara.</p>
